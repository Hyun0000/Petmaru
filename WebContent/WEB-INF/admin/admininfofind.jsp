...
<head>
    ...
    <body>
       ...
       <%@include file ="/WEB-INF/admin_header.jsp" %>
        ...
        <br>
        <div id="loginlogo">
            <h2 style=text-align:center;>관리자 아이디/비밀번호 찾기</h2>
        </div>
        <div id=login_top_line></div>
        <form action="admininfofind" method="POST" id="idfind_form" name = "findID">
        ...
        <form action="admininfofind" method="POST" id="idfind_form" name = "findPwd">
